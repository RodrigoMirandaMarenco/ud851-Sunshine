...
//  COMPLETE (2) Increment the database version after altering the behavior of the table
    /*
...
//              COMPLETE (1) Append NOT NULL to each column's type declaration except for the _ID
                /*
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, int oldVersion, int newVersion) {
        // COMPLETE (3) Within onUpgrade, drop the weather table if it exists
        if (sqLiteDatabase != null) {
            sqLiteDatabase.execSQL("DROP TABLE IF EXISTS " + WeatherEntry.TABLE_NAME);
        }
        // COMPLETE (4) call onCreate and pass in the SQLiteDatabase (passed in to onUpgrade)
