...
public class MainActivity extends AppCompatActivity {
    ...
    private class WeatherQueryTask extends AsyncTask<URL, Void, String[]> {
        ...
        protected String[] doInBackground(URL... urls) {
            try {
                return OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, NetworkUtils.getResponseFromHttpUrl(urls[0]));
            } catch (IOException e) {
                e.printStackTrace();
                return null;
        ...
        protected void onPostExecute(String[] s) {
            ...
            if (s != null && s.length > 0) {
                for (String weatherCondition : s) {
                    mWeatherTextView.append(String.format("%s\n\n\n", weatherCondition));
                }
            }
        }
    }
